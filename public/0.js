...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getUploadFileUrl: function getUploadFileUrl(params) {
      return this.uploadFileUrl + params; // return `/uploads/${this.uploadFilePath}${params}`;
    }
  }
});
...
// module
exports.push([module.i, ".grayscale-filter[data-v-0ec91988] {\n  filter: grayscale(1);\n  transition-property: all;\n  transition-duration: 300ms;\n}\n.grayscale-filter[data-v-0ec91988]:hover {\n  filter: grayscale(0);\n}", ""]);
        ...
        _vm.uploadFilePath
          ? _c("div", { staticClass: "mt-6 text-center" }, [
              _c(
                ...
                {
                  staticClass:
                    "grayscale-filter inline-block shadow hover:shadow-2xl transition-shadow duration-300",
                  attrs: {
                ...
                [
                  _c("img", {
                    ...
                    attrs: {
                      src: _vm.getUploadFileUrl("?colorquant=" + _vm.lumsCount),
                      alt: ""
                    }
                  })
                ]
                  ...
                  _c("div", { staticClass: "absolute right-0 top-0" }, [
                    ...
                    _vm.shownPaletteMenu == index
                      ? _c(
                          ...
                          {
                            staticClass:
                              "absolute right-0 top-100 mr-4 -mt-3 text-left shadow-lg bg-gray-500 py-4 min-w-9 rounded-b-lg rounded-tl-lg z-10"
                          },
                          [
                            _c(
                              "a",
